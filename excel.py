    ...
    for sheet in sheets:
        ...
        for table_name in df['表名称'].unique():
            ...
            for _, row in table_df.iterrows():
                ...
                if oracle_data_type is None:
                    continue
                column_comment = row['字段描述']
...
# 示例使用
file_path = "D:\\DevelopSoftware\\svn\\i17doc\\04_项目实施_SS\\04_DSP咨询设计_ZX\\03_交付物_JF\\02-模型设计\\SS-MB-003_GF-I17_国富人寿_DSP组_数据模型设计_集市层模型设计_v0.5_20241115.xlsx"
sheet_name = "DM-计量接口"  # 如果想处理指定sheet，填写sheet名称；不指定则处理所有sheet
output_file = "DM-jl.sql"  # 输出文件名
